...
// Plan keys (free/starter/growth/agency) are Stripe-bound — display names
// can change freely but plan keys must not. We surface 6 dimensions the
// buyer cares about: channels, posts/month, AI credits, scheduling,
// analytics, and support. These are duplicated in the comparison matrix.
const TIERS = [
  {
    name: 'Free',
    plan: null,
    ...
    monthly: 0,
    annual: 0,
    blurb: 'For testing CortexViral before upgrading',
    cta: 'Start Free',
    micro: 'No credit card. No time limit. Connect 1 channel and ship today.',
    features: [
      '1 connected channel',
    ...
    excluded: ['No trend engine', 'No A/B hook variations', 'No team seats'],
    highlighted: false,
  },
  {
    name: 'Creator',
    ...
    monthly: 15,
    annual: 150,
    blurb: 'For solo creators posting daily',
    cta: 'Start Creator',
    micro: 'For creators posting daily on 2-3 channels — replaces a $40/mo SMM stack.',
    features: [
      '3 connected channels',
      '300 AI generations / month',
      'Unlimited scheduled posts',
      'Standard analytics + post-level insights',
      'Email support (24h response)',
      'A/B hook lab (2 variants)',
      'Trend feed (TikTok + IG)',
    ],
    highlighted: false,
  },
  {
    ...
    annual: 390,
    annualAnchor: 590,
    blurb: 'For serious creators + small brands',
    cta: 'Go Growth',
    micro: 'For creators + 1-3 person brand teams scaling reach across all majors.',
    badge: '🔥 Most Popular',
    earlyBadge: 'Early creator price',
    features: [
      '8 connected channels',
      '1,500 AI generations / month',
      'Unlimited scheduled posts + auto-scheduling',
      'Premium analytics + ROI attribution',
      'Priority email support (8h)',
      'A/B hook lab (5 variants) + winner auto-publish',
      'Full trend engine (all 9 platforms)',
      'Cortex memory (brand voice learning)',
      '2 team seats',
    ],
    highlighted: true,
  },
  {
    ...
    monthly: 99,
    annual: 990,
    blurb: 'For agencies + brands managing many calendars',
    cta: 'Scale Content',
    micro: 'For agencies managing 5+ clients or in-house brand teams scaling content ops.',
    features: [
      'Unlimited channels',
      'Unlimited AI generations',
      'Unlimited scheduled posts + multi-brand calendars',
      'Premium analytics + client report exports',
      'Dedicated Slack channel + 4h response',
      'A/B hook lab (unlimited) + bulk batching',
      'Full trend engine (all platforms)',
      'Multi-brand workspaces + client folders',
      'API access',
...
// Feature comparison matrix — same 6 dimensions as the tier cards above so
// buyers can scan the table without re-reading the cards.
const COMPARISON = [
  { feature: 'Connected channels',         free: '1',          starter: '3',          growth: '8',           agency: 'Unlimited' },
  { feature: 'AI generations / month',     free: '20',         starter: '300',        growth: '1,500',       agency: 'Unlimited' },
  { feature: 'Scheduled posts / month',    free: '5',          starter: 'Unlimited',  growth: 'Unlimited',   agency: 'Unlimited' },
  { feature: 'Optimal-time scheduling',    free: '✓',         starter: '✓',          growth: '✓ auto',      agency: '✓ auto' },
  { feature: 'Analytics depth',            free: 'Basic',     starter: 'Standard',    growth: 'Premium + ROI', agency: 'Premium + exports' },
  { feature: 'A/B hook lab',               free: '—',         starter: '2 variants',  growth: '5 variants',    agency: 'Unlimited' },
  { feature: 'Trend engine',               free: '—',         starter: 'TikTok + IG', growth: 'All 9 platforms', agency: 'All platforms' },
  { feature: 'Cortex memory (brand voice)', free: '—',        starter: '—',           growth: '✓',            agency: '✓' },
  { feature: 'Multi-brand workspaces',     free: '—',         starter: '—',           growth: '—',            agency: '✓' },
  { feature: 'Team seats',                 free: '1',          starter: '1',          growth: '2',            agency: 'Unlimited' },
  { feature: 'API access',                 free: '—',         starter: '—',           growth: '—',            agency: '✓' },
  { feature: 'Support',                    free: 'Community', starter: 'Email 24h',   growth: 'Priority 8h',  agency: 'Dedicated 4h' },
];
